...
// nhắn mới xoá được.
const DANH_SACH_TU_KHOA_CAM = ["bio", "tiểu sử", "trang cá nhân", "profile", "tieusu", "tsu", "tặng lộc", "nhóm share app", "BI🅾️"]; // so khớp KHÔNG phân biệt hoa/thường, khớp NGUYÊN TỪ
